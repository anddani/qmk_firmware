...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  (
   ...
   MO(_FUN2)      , KC_LGUI , KC_LALT  , KC_SPC , KC_SPC , KC_SPC  , MO(_FUN1)  , KC_LEFT  , XXXXXXX  , KC_DOWN  , KC_RGHT
   ),
  ...
  (
   ...
   _______        , _______ , _______  , KC_END , RESET  , _______ , _______  , _______  , _______  , _______  , KC_PSCR  , _______ , _______ , _______ ,
